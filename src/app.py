...
activities = {
    ...
    "Soccer Team": {
        ...
        "max_participants": 18,
        "participants": ["nina@mergington.edu", "jake@mergington.edu"]
    },
    "Swimming Club": {
        "description": "Improve swimming techniques and compete in swim meets",
        "schedule": "Mondays and Wednesdays, 4:00 PM - 5:30 PM",
        "max_participants": 16,
        "participants": ["lila@mergington.edu", "omar@mergington.edu"]
    },
    "Art Club": {
    ...
    "Drama Workshop": {
        ...
        "max_participants": 20,
        "participants": ["carmen@mergington.edu", "ryan@mergington.edu"]
    },
    "Debate Society": {
        "description": "Develop public speaking and critical thinking through debates",
        "schedule": "Mondays, 4:00 PM - 5:30 PM",
        "max_participants": 14,
        "participants": ["sam@mergington.edu", "tori@mergington.edu"]
    },
    "Math Club": {
        "description": "Solve challenging math problems and prepare for competitions",
        "schedule": "Fridays, 3:30 PM - 5:00 PM",
        "max_participants": 18,
        "participants": ["ian@mergington.edu", "zoe@mergington.edu"]
    }
}
